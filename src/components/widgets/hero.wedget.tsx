...
export default function Hero() {
  ...
  return (
    <section className="relative">
                  ...
                  <div className="max-w-full md:max-w-xl text-right">
                    ...
                    <div className="flex sm:flex-row flex-col sm:justify-end gap-3 mt-8">
                        ...
                        <button
                            ...
                            className="bg-white shadow-lg px-6 py-3 rounded-xl font-bold text-[#423CAD] hover:scale-105 transition-all duration-300"
                        >
                            مشاهده محصولات
                        </button>

                        <button className="hover:bg-white/10 px-6 py-3 border border-white/40 rounded-xl font-bold text-white transition-all duration-300">
                            مشاوره رایگان
                        </button>
      ...
      <div className="hidden right-5 md:right-8 lg:right-10 bottom-5 md:bottom-8 lg:bottom-10 absolute md:flex gap-3">
