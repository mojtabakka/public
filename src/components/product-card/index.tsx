                ...
                <div className="  w-full flex md:block sm:block lg:block justify-between ">
                    <figure className="        w-full  flex justify-center  items-center ">
                        {!isEmpty(items?.photos) ? (
                            <Image src={src} alt={items.model} height={10} width={10} className="    h-52 w-52 " />
                        ) : (
                            ...
                            <div className="">
                                ...
                                <div className=" text-right">
                                    <div className="p-1 text-sm flex items-center">
                                        {getToman(items.off ? Math.round(Number(items.priceForUser) - Number(items.priceForUser) * (items.off / 100)) : Number(items.priceForUser))}
